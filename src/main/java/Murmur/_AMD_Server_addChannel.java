...
final class _AMD_Server_addChannel extends IceInternal.IncomingAsync implements AMD_Server_addChannel
{
    public _AMD_Server_addChannel(IceInternal.Incoming in)
    {
        super(in);
    }
