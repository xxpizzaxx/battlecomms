...
public interface _ServerUpdatingAuthenticatorOperations extends _ServerAuthenticatorOperations
{
     ...
     **/
    int registerUser(java.util.Map<UserInfo, java.lang.String> info, Ice.Current __current);
     ...
     **/
    int unregisterUser(int id, Ice.Current __current);
     ...
     **/
    java.util.Map<java.lang.Integer, java.lang.String> getRegisteredUsers(String filter, Ice.Current __current);
     ...
     **/
    int setInfo(int id, java.util.Map<UserInfo, java.lang.String> info, Ice.Current __current);
     ...
     * @return 1 for successfull update, 0 for unsuccessfull update, -1 to fall through.
     **/
    int setTexture(int id, byte[] tex, Ice.Current __current);
}
