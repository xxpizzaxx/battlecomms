...
final class _AMD_Server_removeUserFromGroup extends IceInternal.IncomingAsync implements AMD_Server_removeUserFromGroup
{
    public _AMD_Server_removeUserFromGroup(IceInternal.Incoming in)
    {
        super(in);
    }
