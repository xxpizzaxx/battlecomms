...
final class _AMD_Server_getChannels extends IceInternal.IncomingAsync implements AMD_Server_getChannels
{
    public _AMD_Server_getChannels(IceInternal.Incoming in)
    {
        super(in);
    }

    public void ice_response(java.util.Map<java.lang.Integer, Channel> __ret)
    {
        if(__validateResponse(true))
        {
            try
            {
                ...
                ChannelMapHelper.write(__os, __ret);
