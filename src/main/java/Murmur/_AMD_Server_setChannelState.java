...
final class _AMD_Server_setChannelState extends IceInternal.IncomingAsync implements AMD_Server_setChannelState
{
    public _AMD_Server_setChannelState(IceInternal.Incoming in)
    {
        super(in);
    }
