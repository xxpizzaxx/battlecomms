...
public class ACL implements java.lang.Cloneable, java.io.Serializable
{
    ...
    {
        int __h = 5381;
        __h = IceInternal.HashUtil.hashAdd(__h, "::Murmur::ACL");
        __h = IceInternal.HashUtil.hashAdd(__h, applyHere);
        __h = IceInternal.HashUtil.hashAdd(__h, applySubs);
        ...
        __h = IceInternal.HashUtil.hashAdd(__h, allow);
        __h = IceInternal.HashUtil.hashAdd(__h, deny);
        return __h;
    }
    ...
    public static final long serialVersionUID = -1084304888437399257L;
}
