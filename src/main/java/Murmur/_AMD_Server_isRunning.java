...
final class _AMD_Server_isRunning extends IceInternal.IncomingAsync implements AMD_Server_isRunning
{
    public _AMD_Server_isRunning(IceInternal.Incoming in)
    {
        super(in);
    }
