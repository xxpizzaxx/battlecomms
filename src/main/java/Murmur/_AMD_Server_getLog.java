...
final class _AMD_Server_getLog extends IceInternal.IncomingAsync implements AMD_Server_getLog
{
    public _AMD_Server_getLog(IceInternal.Incoming in)
    {
        super(in);
    }

    public void ice_response(LogEntry[] __ret)
    {
        if(__validateResponse(true))
        {
            try
            {
                ...
                LogListHelper.write(__os, __ret);
