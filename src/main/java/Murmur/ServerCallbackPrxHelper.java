...
public final class ServerCallbackPrxHelper extends Ice.ObjectPrxHelperBase implements ServerCallbackPrx
{
    ...
    private void channelCreated(Channel state, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
        }
        final Ice.Instrumentation.InvocationObserver __observer = IceInternal.ObserverHelper.get(this, "channelCreated", __ctx);
        int __cnt = 0;
        try
        {
            while(true)
    ...
    private void channelRemoved(Channel state, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
        }
        final Ice.Instrumentation.InvocationObserver __observer = IceInternal.ObserverHelper.get(this, "channelRemoved", __ctx);
        int __cnt = 0;
        try
        {
            while(true)
    ...
    private void channelStateChanged(Channel state, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
        }
        final Ice.Instrumentation.InvocationObserver __observer = IceInternal.ObserverHelper.get(this, "channelStateChanged", __ctx);
        int __cnt = 0;
        try
        {
            while(true)
    ...
    private void userConnected(User state, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
        }
        final Ice.Instrumentation.InvocationObserver __observer = IceInternal.ObserverHelper.get(this, "userConnected", __ctx);
        int __cnt = 0;
        try
        {
            while(true)
    ...
    private void userDisconnected(User state, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
        }
        final Ice.Instrumentation.InvocationObserver __observer = IceInternal.ObserverHelper.get(this, "userDisconnected", __ctx);
        int __cnt = 0;
        try
        {
            while(true)
    ...
    private void userStateChanged(User state, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
        }
        final Ice.Instrumentation.InvocationObserver __observer = IceInternal.ObserverHelper.get(this, "userStateChanged", __ctx);
        int __cnt = 0;
        try
        {
            while(true)
    ...
    private static final String __userTextMessage_name = "userTextMessage";
    ...
    {
        userTextMessage(state, message, null, false);
    }
     ...
     * @param __ctx The Context map to send with the invocation.
     **/
    public void userTextMessage(User state, TextMessage message, java.util.Map<String, String> __ctx)
    {
        userTextMessage(state, message, __ctx, true);
    }

    private void userTextMessage(User state, TextMessage message, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
        }
        final Ice.Instrumentation.InvocationObserver __observer = IceInternal.ObserverHelper.get(this, "userTextMessage", __ctx);
        int __cnt = 0;
        try
        {
            while(true)
     ...
     * @param state the User sending the message
     **/
    public Ice.AsyncResult begin_userTextMessage(User state, TextMessage message)
    {
        return begin_userTextMessage(state, message, null, false, null);
    }
     ...
     * @param __ctx The Context map to send with the invocation.
     **/
    public Ice.AsyncResult begin_userTextMessage(User state, TextMessage message, java.util.Map<String, String> __ctx)
    {
        return begin_userTextMessage(state, message, __ctx, true, null);
    }
     ...
     * @param state the User sending the message
     **/
    public Ice.AsyncResult begin_userTextMessage(User state, TextMessage message, Ice.Callback __cb)
    {
        return begin_userTextMessage(state, message, null, false, __cb);
    }
     ...
     * @param __ctx The Context map to send with the invocation.
     **/
    public Ice.AsyncResult begin_userTextMessage(User state, TextMessage message, java.util.Map<String, String> __ctx, Ice.Callback __cb)
    {
        return begin_userTextMessage(state, message, __ctx, true, __cb);
    }
     ...
     * @param state the User sending the message
     **/
    public Ice.AsyncResult begin_userTextMessage(User state, TextMessage message, Callback_ServerCallback_userTextMessage __cb)
    {
        return begin_userTextMessage(state, message, null, false, __cb);
    }
     ...
     * @param __ctx The Context map to send with the invocation.
     **/
    public Ice.AsyncResult begin_userTextMessage(User state, TextMessage message, java.util.Map<String, String> __ctx, Callback_ServerCallback_userTextMessage __cb)
    {
        return begin_userTextMessage(state, message, __ctx, true, __cb);
    }

    private Ice.AsyncResult begin_userTextMessage(User state, TextMessage message, java.util.Map<String, String> __ctx, boolean __explicitCtx, IceInternal.CallbackBase __cb)
    {
        IceInternal.OutgoingAsync __result = new IceInternal.OutgoingAsync(this, __userTextMessage_name, __cb);
        try
        {
            __result.__prepare(__userTextMessage_name, Ice.OperationMode.Idempotent, __ctx, __explicitCtx);
            IceInternal.BasicStream __os = __result.__startWriteParams(Ice.FormatType.DefaultFormat);
            state.__write(__os);
     ...
     * the operation completed successfully.
     **/
    public void end_userTextMessage(Ice.AsyncResult __result)
    {
        __end(__result, __userTextMessage_name);
    }

    public static ServerCallbackPrx checkedCast(Ice.ObjectPrx __obj)
    {
        ServerCallbackPrx __d = null;
        if(__obj != null)
        {
            if(__obj instanceof ServerCallbackPrx)
            {
    ...
    public static ServerCallbackPrx checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ServerCallbackPrx __d = null;
        if(__obj != null)
        {
    ...
    public static ServerCallbackPrx checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ServerCallbackPrx __d = null;
        if(__obj != null)
        {
    ...
    public static ServerCallbackPrx checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ServerCallbackPrx __d = null;
        if(__obj != null)
        {
    ...
    public static ServerCallbackPrx uncheckedCast(Ice.ObjectPrx __obj)
    {
        ServerCallbackPrx __d = null;
        if(__obj != null)
        {
    ...
    public static ServerCallbackPrx uncheckedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ServerCallbackPrx __d = null;
        if(__obj != null)
        {
    ...
    public static void __write(IceInternal.BasicStream __os, ServerCallbackPrx v)
    {
        __os.writeProxy(v);
    }

    public static ServerCallbackPrx __read(IceInternal.BasicStream __is)
    {
