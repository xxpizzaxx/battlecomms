...
final class _AMD_Server_redirectWhisperGroup extends IceInternal.IncomingAsync implements AMD_Server_redirectWhisperGroup
{
    public _AMD_Server_redirectWhisperGroup(IceInternal.Incoming in)
    {
        super(in);
    }
