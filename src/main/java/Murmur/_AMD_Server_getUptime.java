...
final class _AMD_Server_getUptime extends IceInternal.IncomingAsync implements AMD_Server_getUptime
{
    public _AMD_Server_getUptime(IceInternal.Incoming in)
    {
        super(in);
    }
