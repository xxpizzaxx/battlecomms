...
final class _AMD_Meta_getAllServers extends IceInternal.IncomingAsync implements AMD_Meta_getAllServers
{
    public _AMD_Meta_getAllServers(IceInternal.Incoming in)
    {
        super(in);
    }
