...
final class _AMD_Server_getUserNames extends IceInternal.IncomingAsync implements AMD_Server_getUserNames
{
    public _AMD_Server_getUserNames(IceInternal.Incoming in)
    {
        super(in);
    }
