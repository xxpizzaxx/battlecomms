...
final class _AMD_Server_removeContextCallback extends IceInternal.IncomingAsync implements AMD_Server_removeContextCallback
{
    public _AMD_Server_removeContextCallback(IceInternal.Incoming in)
    {
        super(in);
    }
