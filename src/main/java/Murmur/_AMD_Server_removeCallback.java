...
final class _AMD_Server_removeCallback extends IceInternal.IncomingAsync implements AMD_Server_removeCallback
{
    public _AMD_Server_removeCallback(IceInternal.Incoming in)
    {
        super(in);
    }
