...
final class _AMD_Server_getACL extends IceInternal.IncomingAsync implements AMD_Server_getACL
{
    public _AMD_Server_getACL(IceInternal.Incoming in)
    {
        super(in);
    }

    public void ice_response(ACL[] acls, Group[] groups, boolean inherit)
    {
