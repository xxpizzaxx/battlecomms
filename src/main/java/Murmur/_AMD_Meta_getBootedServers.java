...
final class _AMD_Meta_getBootedServers extends IceInternal.IncomingAsync implements AMD_Meta_getBootedServers
{
    public _AMD_Meta_getBootedServers(IceInternal.Incoming in)
    {
        super(in);
    }

    public void ice_response(ServerPrx[] __ret)
    {
        if(__validateResponse(true))
        {
            try
            {
                ...
                ServerListHelper.write(__os, __ret);
