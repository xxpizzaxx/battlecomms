...
final class _AMD_Server_getBans extends IceInternal.IncomingAsync implements AMD_Server_getBans
{
    public _AMD_Server_getBans(IceInternal.Incoming in)
    {
        super(in);
    }

    public void ice_response(Ban[] __ret)
    {
        if(__validateResponse(true))
        {
            try
            {
                ...
                BanListHelper.write(__os, __ret);
