...
final class _AMD_Server_verifyPassword extends IceInternal.IncomingAsync implements AMD_Server_verifyPassword
{
    public _AMD_Server_verifyPassword(IceInternal.Incoming in)
    {
        super(in);
    }
