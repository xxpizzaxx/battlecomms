...
final class _AMD_Server_getChannelState extends IceInternal.IncomingAsync implements AMD_Server_getChannelState
{
    public _AMD_Server_getChannelState(IceInternal.Incoming in)
    {
        super(in);
    }

    public void ice_response(Channel __ret)
    {
