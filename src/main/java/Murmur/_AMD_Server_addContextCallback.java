...
final class _AMD_Server_addContextCallback extends IceInternal.IncomingAsync implements AMD_Server_addContextCallback
{
    public _AMD_Server_addContextCallback(IceInternal.Incoming in)
    {
        super(in);
    }
