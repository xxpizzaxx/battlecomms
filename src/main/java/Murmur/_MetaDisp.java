...
public abstract class _MetaDisp extends Ice.ObjectImpl implements Meta
{
     ...
     **/
    public final void addCallback_async(AMD_Meta_addCallback __cb, MetaCallbackPrx cb)
     ...
     * @param __cb The callback object for the operation.
     **/
    public final void getAllServers_async(AMD_Meta_getAllServers __cb)
     ...
     * @param __cb The callback object for the operation.
     **/
    public final void getBootedServers_async(AMD_Meta_getBootedServers __cb)
        throws InvalidSecretException
    {
     ...
     * @param __cb The callback object for the operation.
     **/
    public final void getDefaultConf_async(AMD_Meta_getDefaultConf __cb)
        throws InvalidSecretException
    {
     ...
     **/
    public final void getServer_async(AMD_Meta_getServer __cb, int id)
        throws InvalidSecretException
    {
     ...
     * @param __cb The callback object for the operation.
     **/
    public final void getSlice_async(AMD_Meta_getSlice __cb)
    {
     ...
     * @param __cb The callback object for the operation.
     **/
    public final void getSliceChecksums_async(AMD_Meta_getSliceChecksums __cb)
    {
     ...
     * @param __cb The callback object for the operation.
     **/
    public final void getUptime_async(AMD_Meta_getUptime __cb)
    {
     ...
     * @param __cb The callback object for the operation.
     **/
    public final void getVersion_async(AMD_Meta_getVersion __cb)
    {
     ...
     * @param __cb The callback object for the operation.
     **/
    public final void newServer_async(AMD_Meta_newServer __cb)
        throws InvalidSecretException
    {
     ...
     **/
    public final void removeCallback_async(AMD_Meta_removeCallback __cb, MetaCallbackPrx cb)
        throws InvalidCallbackException,
               InvalidSecretException
    {
    ...
    public static Ice.DispatchStatus ___getServer(Meta __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
    ...
    public static Ice.DispatchStatus ___newServer(Meta __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
    ...
    public static Ice.DispatchStatus ___getBootedServers(Meta __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Idempotent, __current.mode);
        __inS.readEmptyParams();
    ...
    public static Ice.DispatchStatus ___getAllServers(Meta __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Idempotent, __current.mode);
        __inS.readEmptyParams();
    ...
    public static Ice.DispatchStatus ___getDefaultConf(Meta __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Idempotent, __current.mode);
        __inS.readEmptyParams();
    ...
    public static Ice.DispatchStatus ___getVersion(Meta __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Idempotent, __current.mode);
        __inS.readEmptyParams();
    ...
    public static Ice.DispatchStatus ___addCallback(Meta __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        IceInternal.BasicStream __is = __inS.startReadParams();
        MetaCallbackPrx cb;
    ...
    public static Ice.DispatchStatus ___removeCallback(Meta __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        IceInternal.BasicStream __is = __inS.startReadParams();
        MetaCallbackPrx cb;
    ...
    public static Ice.DispatchStatus ___getUptime(Meta __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Idempotent, __current.mode);
        __inS.readEmptyParams();
    ...
    public static Ice.DispatchStatus ___getSlice(Meta __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Idempotent, __current.mode);
        __inS.readEmptyParams();
    ...
    public static Ice.DispatchStatus ___getSliceChecksums(Meta __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Idempotent, __current.mode);
        __inS.readEmptyParams();
