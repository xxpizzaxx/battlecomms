...
final class _AMD_Server_setTexture extends IceInternal.IncomingAsync implements AMD_Server_setTexture
{
    public _AMD_Server_setTexture(IceInternal.Incoming in)
    {
        super(in);
    }
