...
final class _AMD_Server_sendMessage extends IceInternal.IncomingAsync implements AMD_Server_sendMessage
{
    public _AMD_Server_sendMessage(IceInternal.Incoming in)
    {
        super(in);
    }
