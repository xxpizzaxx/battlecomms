...
final class _AMD_Server_getTree extends IceInternal.IncomingAsync implements AMD_Server_getTree
{
    public _AMD_Server_getTree(IceInternal.Incoming in)
    {
        super(in);
    }

    public void ice_response(Tree __ret)
    {
