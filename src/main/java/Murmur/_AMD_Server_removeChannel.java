...
final class _AMD_Server_removeChannel extends IceInternal.IncomingAsync implements AMD_Server_removeChannel
{
    public _AMD_Server_removeChannel(IceInternal.Incoming in)
    {
        super(in);
    }
