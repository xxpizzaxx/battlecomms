...
final class _AMD_Server_unregisterUser extends IceInternal.IncomingAsync implements AMD_Server_unregisterUser
{
    public _AMD_Server_unregisterUser(IceInternal.Incoming in)
    {
        super(in);
    }
