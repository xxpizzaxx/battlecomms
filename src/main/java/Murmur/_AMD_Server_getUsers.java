...
final class _AMD_Server_getUsers extends IceInternal.IncomingAsync implements AMD_Server_getUsers
{
    public _AMD_Server_getUsers(IceInternal.Incoming in)
    {
        super(in);
    }

    public void ice_response(java.util.Map<java.lang.Integer, User> __ret)
    {
        if(__validateResponse(true))
        {
            try
            {
                ...
                UserMapHelper.write(__os, __ret);
