...
final class _AMD_Server_getTexture extends IceInternal.IncomingAsync implements AMD_Server_getTexture
{
    public _AMD_Server_getTexture(IceInternal.Incoming in)
    {
        super(in);
    }
