...
public abstract class Callback_Server_getChannels extends Ice.TwowayCallback
{
    public abstract void response(java.util.Map<java.lang.Integer, Channel> __ret);
    public abstract void exception(Ice.UserException __ex);

    public final void __completed(Ice.AsyncResult __result)
    {
        ServerPrx __proxy = (ServerPrx)__result.getProxy();
        java.util.Map<java.lang.Integer, Channel> __ret = null;
        try
        {
