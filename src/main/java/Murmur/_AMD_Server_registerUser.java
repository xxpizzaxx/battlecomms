...
final class _AMD_Server_registerUser extends IceInternal.IncomingAsync implements AMD_Server_registerUser
{
    public _AMD_Server_registerUser(IceInternal.Incoming in)
    {
        super(in);
    }
