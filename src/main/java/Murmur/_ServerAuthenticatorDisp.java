...
public abstract class _ServerAuthenticatorDisp extends Ice.ObjectImpl implements ServerAuthenticator
{
    ...
    public static Ice.DispatchStatus ___authenticate(ServerAuthenticator __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
    ...
    public static Ice.DispatchStatus ___getInfo(ServerAuthenticator __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Idempotent, __current.mode);
        IceInternal.BasicStream __is = __inS.startReadParams();
        int id;
    ...
    public static Ice.DispatchStatus ___nameToId(ServerAuthenticator __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Idempotent, __current.mode);
        IceInternal.BasicStream __is = __inS.startReadParams();
        String name;
    ...
    public static Ice.DispatchStatus ___idToName(ServerAuthenticator __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Idempotent, __current.mode);
        IceInternal.BasicStream __is = __inS.startReadParams();
        int id;
    ...
    public static Ice.DispatchStatus ___idToTexture(ServerAuthenticator __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Idempotent, __current.mode);
        IceInternal.BasicStream __is = __inS.startReadParams();
        int id;
