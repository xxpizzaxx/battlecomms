...
final class _AMD_Server_setAuthenticator extends IceInternal.IncomingAsync implements AMD_Server_setAuthenticator
{
    public _AMD_Server_setAuthenticator(IceInternal.Incoming in)
    {
        super(in);
    }
