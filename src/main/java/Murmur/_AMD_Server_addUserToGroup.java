...
final class _AMD_Server_addUserToGroup extends IceInternal.IncomingAsync implements AMD_Server_addUserToGroup
{
    public _AMD_Server_addUserToGroup(IceInternal.Incoming in)
    {
        super(in);
    }
