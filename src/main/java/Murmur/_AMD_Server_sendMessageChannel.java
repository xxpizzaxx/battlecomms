...
final class _AMD_Server_sendMessageChannel extends IceInternal.IncomingAsync implements AMD_Server_sendMessageChannel
{
    public _AMD_Server_sendMessageChannel(IceInternal.Incoming in)
    {
        super(in);
    }
