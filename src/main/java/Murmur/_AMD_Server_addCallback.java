...
final class _AMD_Server_addCallback extends IceInternal.IncomingAsync implements AMD_Server_addCallback
{
    public _AMD_Server_addCallback(IceInternal.Incoming in)
    {
        super(in);
    }
