...
final class _AMD_Server_updateRegistration extends IceInternal.IncomingAsync implements AMD_Server_updateRegistration
{
    public _AMD_Server_updateRegistration(IceInternal.Incoming in)
    {
        super(in);
    }
