...
final class _AMD_Server_getLogLen extends IceInternal.IncomingAsync implements AMD_Server_getLogLen
{
    public _AMD_Server_getLogLen(IceInternal.Incoming in)
    {
        super(in);
    }
