...
final class _AMD_Server_getRegisteredUsers extends IceInternal.IncomingAsync implements AMD_Server_getRegisteredUsers
{
    public _AMD_Server_getRegisteredUsers(IceInternal.Incoming in)
    {
        super(in);
    }

    public void ice_response(java.util.Map<java.lang.Integer, java.lang.String> __ret)
    {
